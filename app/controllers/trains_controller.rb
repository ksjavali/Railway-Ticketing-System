class TrainsController < ApplicationController
  ...
  private
    ...
    def train_params
      params.require(:train).permit(:train_number, :departure_station, :termination_station, :departure_date, :arrival_date, :departure_time, :arrival_time, :ticket_price, :seats_left)
    end
end
